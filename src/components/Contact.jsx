      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {contactInfo.map((info, index) => (
            <div 
              key={index} 
              className="glass p-6 rounded-lg text-center flex flex-col items-center transform transition-all duration-300 hover:-translate-y-2"
            >
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Textarea
                    ...
                    onChange={handleChange}
                    required
                    className="min-h-32 bg-secondary/30 border-secondary"
                  />
                </div>
                <Button 
                  type="submit" 
          ...
          <div className="glass p-6 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4">Let's Connect on Social Media</h3>
              ...
              <div className="flex justify-center gap-6">
                {[
                  ...
                  {
                    name: "LeetCode",
                    url: "https://leetcode.com/u/krishna_singh27",
                    icon: (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  {
                    name: "Codeforces",
                    url: "https://codeforces.com/profile/Krishna_Singh27",
                    icon: (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  {
                    name: "CodeChef",
                    url: "https://www.codechef.com/users/krishnasingh27",
                    icon: (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
